...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] LAYOUT(
     ...
     //                                            bkspc    enter     caps    space    left     down      up      right
      _______,  _______,   TO(_TYPE), TO(_FN),    FN_BS,   PN_ENT,  KC_CAPS, SPC_PN,  KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
    ),
    // [_KAI] LAYOUT(
    ...
    _______, _______, _______, SCNSHOT,   DIVVY, SPOTLT, _______,                   _______, KC_7, KC_8, KC_9, KC_PLUS, KC_PERC, _______,
            ...
            _______,    REDO,  WKSPLF,  MSNCTL,  WKSPRT, _______, _______,  _______,_______, KC_1, KC_2, KC_3, KC_SLSH, _______,
                TO(_BASE),TO(_BASE),TO(_BASE),TO(_BASE), _______,  _______, _______,   KC_0,   KC_DOT,_______,_______, _______
    //
    ...
    [_TYPE] LAYOUT(
    KC_ESC, KC_GRV, KC_Q,    KC_W,    KC_F,    KC_P,    KC_B,     KC_J,    KC_L,    KC_U,    KC_Y,    KC_SCLN, KC_LBRC, KC_RBRC,
    KC_TAB,   KC_A,   KC_R,    KC_S,    KC_T,    KC_G,      KC_BSLS,    KC_M,    KC_N,    KC_E,    KC_I,    KC_O,    KC_QUOT,
    KC_LSFT,    KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,    KC_MINS,  KC_EQL,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    TO(_BASE),TO(_BASE),TO(_BASE),TO(_BASE),  FN_BS,  PN_ENT,  KC_CAPS,LT(_PN, KC_SPC),   KC_LEFT,    KC_DOWN,    KC_UP,  KC_RGHT
    )
};
