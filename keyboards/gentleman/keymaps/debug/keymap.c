...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    // ),
    [_PN] LAYOUT(
    _______, _______, KC_TILD, KC_ASTR, KC_AMPR, KC_LCBR, KC_RCBR, _______, _______, _______, _______, _______, _______, _______,
        _______, KC_HASH, KC_AT, KC_EXLM, KC_LPRN, KC_RPRN, _______, _______, _______, _______, _______, _______, _______,
    _______, KC_CIRC, KC_PERC, KC_DLR, KC_LBRC, KC_RBRC, KC_UNDS, _______, _______, _______, _______, _______, _______, _______,
